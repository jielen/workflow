 ...
 public class DeactivateService extends BasicService
 {
   private static Logger logger = Logger.getLogger(DeactivateService.class);
   ...
   public void _deactivate(WorkflowContext context) throws WorkflowException {
     try {
       Long instanceId = context.getInstanceId();
       String user = context.getExecutor();
       InstanceModel instance = getRuntimeService().getInstanceById(
         instanceId);
   ...
   private void createActionHistory(Long instanceId, WorkflowContext context) {
     ...
     actionHistory.setActionName("deactivate_instance");
 ...
 * Qualified Name:     com.kingdrive.workflow.service.DeactivateService
